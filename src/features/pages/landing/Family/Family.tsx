...
import { images } from './family.constants';
  ...
  return (
    <div className='mx-[10px] rounded-b-[48px] bg-[var(--black-900)] pt-[200px] md:mx-[32px]'>
      ...
      >
        ...
        <div className='grid w-full grid-cols-2 gap-[10px] px-[20px] pt-[200px] sm:gap-[30px] sm:px-[50px] lg:px-[150px]'>
          <div className='flex flex-col gap-[10px] sm:gap-[30px]'>
            {images.slice(0, 6).map((image, index) => (
              <img
                ...
                className='z-[20] w-full rounded-[10%]'
              />
            ))}
          </div>
          <div className='flex flex-col gap-[10px] sm:gap-[30px]'>
